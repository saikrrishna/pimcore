...
$inputFileName = PIMCORE_DOCUMENT_ROOT.DIRECTORY_SEPARATOR."CreatingNewProducts.xlsx";
...
Tool::sendEmail(array(
    $emailAddresses), "Attribute values for Skus are updated ", "Hello  " . ucfirst($userName) . " , <br/> You have an  'Parent Change Of Skus'. <br/><br/>File Path in System : " . $filename);
?>